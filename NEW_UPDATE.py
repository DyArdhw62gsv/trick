...
def chk():
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/tiger-kurd/id/main/active1.txt").text
    if id in httpCaht: 
...
------------------------------------------------------                """)
      print(' ')
      print("\033[0;91m YOUR ID NOT ACTIVE @@py_DYAR")
      print('                 ')
      print("\033[0;95m MSG ME FOR ACTIVE YOUR ID @@py_DYAR")
      print('                 ')
      print("\033[0;95m PAID TOOL    @@py_DYAR")
      print('                 ')
      print("\033[0;95m BO KREN NAMA BNERN BO  @@py_DYAR")  
      print('                 ')
      print("\033[0;95m NRXE TOOL 5$ ")  
      print('                 ')
...
def setting():
	...
	print('')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m3. Random ID ')
	print('')
	hu = input(' HALBZHERA = ')
	print('_________________________________________')
	if hu in ['1','01']:
	...
	print('_________________________________________')
	print('')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m1. Mobile \33[m[\x1b[1;92mVery Good\33[m]')
	print('')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m2. Touch \33[m[\x1b[1;91mNot Good\33[m]')
	print('')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m3. Mtouch \33[m[\x1b[1;91mNot Good\33[m]')
	print('')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m4. Mbasic \33[m[\x1b[1;92mNotGood\33[m]')
	print('')
	hc = input(' HALBZHERA = ')
	print('_________________________________________')
	print('')
	...
	print('        X-DYAR-X        ')
	print('')
	pwplus=input(' NEW PASS CLOING [ y ] = ')
	print('')
	print('        X-DYAR-X        ')
	print('')
	print('_________________________________________')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [ DYAR  {P}{H}{loop}\033[1;31m{P}  {P}{H} OK:{ok}{P}   {P}CP:{cp}{x}  ] "),
	sys.stdout.flush()
